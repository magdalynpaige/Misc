...
import sys
sys.path.insert(0, '/home/maggie/AUEG2/Desktop/Guider')
#from Guider2 import *
...
class GuiderControl(wx.Panel):
    def __init__(self,parent, debug, night):
        ...
        #self.SetSizer(self.vbox)
        #self.Bind(wx.EVT_BUTTON, self.onExposureButton, self.guiderExposureButton)

        def onExposureButton(self, event):
            #self.guiderExposureButton = wx.Button(self, -1, 'Guider Exposure', size=(125, -1))
            self.t.expTime.SetLabel(self.guiderTimeText())
